...
class ClassMemDataLoader():
    ...
    def __init__(self, dataset, batch_size, device, drop_last=False):
        self.device = device
...
def load_data(args):
    ...
    if args.dataset.startswith('cifar'):
        ...
        if args.dataset == 'cifar100':
            train_dataset = datasets.CIFAR100(args.data_dir, train=True, download=True, transform=train_transform)
            val_dataset = datasets.CIFAR100(args.data_dir, train=False, download=True, transform=test_transform)
            nclass = 100
        elif args.dataset == 'cifar10':
            train_dataset = datasets.CIFAR10(args.data_dir, train=True, download=True, transform=train_transform)
            val_dataset = datasets.CIFAR10(args.data_dir, train=False, download=True, transform=test_transform)
            nclass = 10
        else:
        ...
        train_dataset = datasets.FashionMNIST(args.data_dir, train=True, download=True, transform=train_transform)
        val_dataset = datasets.FashionMNIST(args.data_dir, train=False, download=True, transform=test_transform)
        nclass = 10
        ...
        val_dataset = datasets.MNIST(args.data_dir, train=False, download=True, transform=test_transform)
        nclass = 10
